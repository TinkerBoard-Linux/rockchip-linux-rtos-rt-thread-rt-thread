...
{
    HAL_PINCTRL_SetRMIO(GPIO_BANK4,
                        GPIO_PIN_B5,   // SAI2_TDM_SCLK
                        RMIO_SAI2_SCLK);

    HAL_PINCTRL_SetRMIO(GPIO_BANK4,
                        GPIO_PIN_B6,   // SAI2_TDM_LRCK
                        RMIO_SAI2_LRCK);

    HAL_PINCTRL_SetRMIO(GPIO_BANK4,
                        GPIO_PIN_B7,   // SAI2_TDM_SDI0
                        RMIO_SAI2_SDI0);
}
...
void sai4_iomux_config(void)
{
    ...
    HAL_PINCTRL_SetRMIO(GPIO_BANK4,    // SAI4_TDM_MCLK
                        GPIO_PIN_D3, RMIO_SAI4_MCLK);
}
...
{
    HAL_PINCTRL_SetRMIO(GPIO_BANK4,
                        GPIO_PIN_C0,   // SAI5_TDM_SCLK
                        RMIO_SAI5_SCLK);

    HAL_PINCTRL_SetRMIO(GPIO_BANK4,
                        GPIO_PIN_C1,   // SAI5_TDM_LRCK
                        RMIO_SAI5_LRCK);

    HAL_PINCTRL_SetRMIO(GPIO_BANK4,
                        GPIO_PIN_C2,   // SAI5_TDM_SDI0
                        RMIO_SAI5_SDI0);
}
 ...
 */
void sai6_iomux_config(void)
{
    HAL_PINCTRL_SetRMIO(GPIO_BANK4,
                        GPIO_PIN_D0,   // SAI6_TDM_SCLK
                        RMIO_SAI6_SCLK);

    HAL_PINCTRL_SetRMIO(GPIO_BANK4,
                        GPIO_PIN_D1,   // SAI6_TDM_LRCK
                        RMIO_SAI6_LRCK);

    HAL_PINCTRL_SetRMIO(GPIO_BANK4,
                        GPIO_PIN_D2,   // SAI6_TDM_SDI0
                        RMIO_SAI6_SDI0);
}
...
void uart2_iomux_config(void)
{
    HAL_PINCTRL_SetRMIO(GPIO_BANK3,
                        GPIO_PIN_B5,   // UART2_TX_AUDIO_DEBUG
                        RMIO_UART2_TX_RM1);

    HAL_PINCTRL_SetRMIO(GPIO_BANK3,
                        GPIO_PIN_B6,   // UART2_RX_AUDIO_DEBUG
                        RMIO_UART2_RX_RM1);
}
