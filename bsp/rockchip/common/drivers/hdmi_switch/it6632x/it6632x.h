...
typedef enum
{
    IT6632X_AUDIO_PATH_PASSTHROUGH,
    IT6632X_AUDIO_PATH_HDMI_0,
    IT6632X_AUDIO_PATH_HDMI_1,
    IT6632X_AUDIO_PATH_HDMI_2,
    IT6632X_AUDIO_PATH_ARC,
    IT6632X_AUDIO_PATH_BT,    //ext i2s 1
    IT6632X_AUDIO_PATH_SPDIF,
} it6632x_audio_path_t;
...
typedef enum
{
    IT6632X_AUDIO_TYPE_LPCM = 0,
    IT6632X_AUDIO_TYPE_NLPCM = 1,
    IT6632X_AUDIO_TYPE_HBR = 2,
    IT6632X_AUDIO_TYPE_DSD = 3
} it6632x_audio_type_t;
...
struct it6632x_ado_info
{
    ...
    it6632x_audio_type_t audio_type;
...
typedef enum
{
    IT6632X_CEC_CTRL_VOL_MUTE,
    IT6632X_CEC_CTRL_VOL_UP,
    IT6632X_CEC_CTRL_VOL_DOWN,
} it6632x_cec_cmd_t;
...
typedef enum
{
    RT_IT6632X_CTRL_POWER_MODE_SET,
    RT_IT6632X_CTRL_AUDIO_PATH_SELECT,
    RT_IT6632X_CTRL_ARC_VOL_SET,
    RT_IT6632X_CTRL_ARC_VOL_GET,
    ...
    RT_IT6632X_CTRL_REGISTER_AUDIO_CHANGE_HOOK,
    RT_IT6632X_CTRL_UNREGISTER_AUDIO_CHANGE_HOOK,
    RT_IT6632X_CTRL_REGISTER_CEC_VOL_CHANGE_HOOK,
    RT_IT6632X_CTRL_UNREGISTER_CEC_VOL_CHANGE_HOOK,
    RT_IT6632X_CTRL_REGISTER_RX_MUTE_HOOK,
    RT_IT6632X_CTRL_UNREGISTER_RX_MUTE_HOOK,

    //for test
    RT_IT6632X_CTRL_PIN_TSET,
    RT_IT6632X_CTRL_CEC_TEST,
} it6632x_ctrl_t;
